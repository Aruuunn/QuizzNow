declare namespace COMPODOC_SEARCH_INDEX {
    namespace index {
        const version: string;
        const fields: string[];
        const fieldVectors: (string | number[])[][];
        const invertedIndex: ((string | {
            _index: number;
            title: {};
            body: {
