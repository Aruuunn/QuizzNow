(function (compodoc) {
    ...
    LunrSearchEngine.prototype.init = function () {
        var that = this, d = new promise.Promise();
    ...
    LunrSearchEngine.prototype.search = function (q, offset, length) {
        var that = this, results = [], d = new promise.Promise();
        if (this.index) {
    ...
    compodoc.addEventListener(compodoc.EVENTS.READY, function (event) {
        var engine = new LunrSearchEngine(), initialized = false;
...
//# sourceMappingURL=search-lunr.js.map