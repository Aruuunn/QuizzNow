(function (compodoc) {
    var usePushState = (typeof history.pushState !== 'undefined'), $body = $('body'), $searchResults, $searchInput, $searchList, $searchTitle, $searchResultsCount, $searchQuery, $mainContainer, $xsMenu;
